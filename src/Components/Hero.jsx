      ...
      <div className="container mx-auto flex flex-col  md: lg: xl: 2xl: md:flex-row items-center justify-between p-4">
        <div className=" flex flex-col gap-14 md:max-w-[1000px]">
          ...
          <p className="text-sm lg:text-2xl md:text-3xl mb-12 text-center md:text-left overflow-hidden  ">
            ...
            Our system streamlines hospital operations, enhances patient care, and improves overall efficiency. With cutting-edge features and user-friendly interfaces, we ensure that healthcare providers can focus on what matters most—delivering exceptional care to their patients.
          </p>
