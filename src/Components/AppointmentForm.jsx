    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 py-12 mt-10">
      <div className="flex flex-col md:flex-row items-center w-full max-w-6xl mb-8">
        <div className="md:w-1/2 p-4">
          ...
          <p className="text-lg text-gray-700 mb-6 hidden md:block">
            Schedule your appointment with our expert medical team. Our streamlined booking process ensures you receive the care you need when you need it. Whether it's a routine check-up or a specialized consultation, we are here to provide you with the best healthcare services.
          </p>
        </div>
      ...
      <div className="w-full max-w-6xl p-8 bg-white rounded-lg shadow-lg">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className={`${loading ? "bg-red-600" : "bg-blue-600"
